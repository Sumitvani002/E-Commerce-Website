						...
						<div class="flex-w flex-t bor12 p-t-15 p-b-30">
							...
							<div class="size-209 p-r-18 p-r-0-sm w-full-ssm">
								<p class="stext-111 cl6 p-t-2">
									We will deliver anywhere by Near our COZA Store
								</p>
								...
								<div class="p-t-15">
									...
									<div class="bor8 bg0 m-b-12">
										<input class="stext-111 cl8 plh3 size-111 p-lr-15" type="text" name="caddress" placeholder="address">
									</div>
								...
								<form action="transfer.html">
										<button type="submit" action="transfer.html"> 
												Online 
										</button>
										</form>
								...
								<form action ="handler/orderhandler.php" metho="POST">
								</div>
							</div>
						</div>
